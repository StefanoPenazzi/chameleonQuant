...
public class InternalTimeSeriesCleaningModule extends AbstractModule {
	...
	@Override
	public void install() {
		addInternalTimeSeriesCleaner("NULL_INFLUXDB").to((Class<? extends TimeSeriesCleanerI<? extends InternalTimeSeriesPoint>>) TimeSeriesCleanerNullValuesStockInfluxdb.class);
